[![Build Status](https://travis-ci.org/xm-online/tmf-ms-promotion.svg?branch=master)](https://travis-ci.org/xm-online/tmf-ms-promotion) [![Quality Gate](https://sonarcloud.io/api/project_badges/measure?&metric=sqale_index&branch=master&project=xm-online:tmf-ms-promotion)](https://sonarcloud.io/dashboard/index/xm-online:tmf-ms-promotion) [![Quality Gate](https://sonarcloud.io/api/project_badges/measure?&metric=ncloc&branch=master&project=xm-online:tmf-ms-promotion)](https://sonarcloud.io/dashboard/index/xm-online:tmf-ms-promotion) [![Quality Gate](https://sonarcloud.io/api/project_badges/measure?&metric=coverage&branch=master&project=xm-online:tmf-ms-promotion)](https://sonarcloud.io/dashboard/index/xm-online:tmf-ms-promotion)
...
To build the final jar and optimize the promotion application for production, run:
