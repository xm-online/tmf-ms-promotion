package com.icthh.xm.tmf.ms.promotion.config.timezone;
...
/**
 * Int tests for the UTC Hibernate configuration.
 */
public class HibernateTimeZoneIntTest extends AbstractSpringBootTest {
